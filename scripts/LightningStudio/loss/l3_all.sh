...
#
#   bash scripts/LightningStudio/run_both.sh loss/l3_all.sh             # ℓ=5
#   bash scripts/LightningStudio/run_both.sh loss/l3_all.sh TL_ELL=3
#   bash scripts/LightningStudio/run_both.sh loss/l3_all.sh TL_ELL=7
set -euo pipefail
