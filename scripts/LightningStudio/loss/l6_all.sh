...
#
#   bash scripts/LightningStudio/run_both.sh loss/l6_all.sh PSTAR=bce
#   bash scripts/LightningStudio/run_both.sh loss/l6_all.sh PSTAR=bce SEARCH_TVERSKY=true
set -euo pipefail
