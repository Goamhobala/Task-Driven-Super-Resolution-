...
#
#   bash scripts/LightningStudio/run_pair.sh --A=loss/l7_all.sh --B=loss/l7_all.sh \
#       A.CL_ALPHA=0.2 B.CL_ALPHA=0.5 BSTAR=pstar_dice PSTAR=bce MIX_W=0.63    # grid ends
#   bash scripts/LightningStudio/run_both.sh loss/l7_all.sh BSTAR=pstar_dice PSTAR=bce MIX_W=0.63  # centre 0.3
set -euo pipefail
