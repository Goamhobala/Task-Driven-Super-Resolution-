...
#
#   bash scripts/LightningStudio/run_pair.sh --A=loss/l8_all.sh --B=loss/l8_all.sh \
#       A.SR_W=0.5 B.SR_W=2 BSTAR=pstar_dice PSTAR=bce MIX_W=0.63             # grid ends
#   bash scripts/LightningStudio/run_both.sh loss/l8_all.sh BSTAR=pstar_dice PSTAR=bce MIX_W=0.63  # centre w=1
set -euo pipefail
