...
#
#   bash scripts/LightningStudio/run.sh sr/r4a_cdngi.sh STAGE=tune [SEED=n] [LOSS_ARM=arm]
#   bash scripts/LightningStudio/run.sh sr/r4a_cdngi.sh STAGE=fit [SEED=n] [LOSS_ARM=arm]
set -euo pipefail
