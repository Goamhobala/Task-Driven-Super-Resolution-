...
#
#   bash scripts/LightningStudio/run.sh sr/r4b_all.sh STAGE=tune [SEED=n] [LOSS_ARM=arm]
#   bash scripts/LightningStudio/run.sh sr/r4b_all.sh STAGE=fit  [SEED=n] [LOSS_ARM=arm]
#
