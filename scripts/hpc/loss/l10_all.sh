...
#
#   sbatch scripts/hpc/train_pair.sbatch --A=loss/l10_all.sh --B=loss/l10_all.sh B.POS_WEIGHT=40
#   sbatch scripts/hpc/train_pair.sbatch --A=loss/l10_all.sh --B=loss/l5_all.sh B.PSTAR=wbce
set -euo pipefail
