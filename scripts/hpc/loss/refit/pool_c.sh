#!/bin/bash
# Refit pool c — 7 arm(s) on 1 GPU(s), all in ONE SLURM job.
#
#   cd scripts/hpc
...
export ARMS="gap_t2_ce_dice gap_t2_ce_sdice gap_tl_ce gap_tl_dice gapt4_pstar_sdice t2_ce wbce_dice"
export NGPU=1
