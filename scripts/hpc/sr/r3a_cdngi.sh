...
#
#   sbatch scripts/hpc/train.sbatch --SCRIPT=sr/r3a_cdngi.sh STAGE=tune [SEED=n]
#   sbatch --gres=gpu:1 scripts/hpc/train.sbatch --SCRIPT=sr/r3a_cdngi.sh STAGE=fit [SEED=n]
set -euo pipefail
