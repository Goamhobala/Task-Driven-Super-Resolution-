...
# Usage: ./scripts/run_chip_creator_parallel.sh <csv_path> <output_dir> [chunk_size]
...
CSV_PATH="${1:?Usage: $0 <csv_path> <output_dir> [chunk_size]}"
OUTPUT_DIR="${2:?Usage: $0 <csv_path> <output_dir> [chunk_size]}"
CHUNK_SIZE="${3:-100}"
