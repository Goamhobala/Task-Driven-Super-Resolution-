...
def run_eval(
    ...
    hc_mask_path: Annotated[Optional[Path], typer.Option(help="Override the checkpoint's baked-in hard-constraint mask path (SEN2SR-Lite's shipped safetensor), for sr_hc='on' runs evaluated on a different node")] = None,
    ...
    run_id = evaluate(
        ...
        mask_dirname=mask_dirname, sen2sr_dir=sen2sr_dir, hc_mask_path=hc_mask_path,
